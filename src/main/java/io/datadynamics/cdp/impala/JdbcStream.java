...
import com.cloudera.impala.jdbc.jdbc42.S42ForwardResultSet;
...
public class JdbcStream extends JdbcTemplate {
    ...
    // https://github.com/amarflybot/spring-boot-impala/blob/master/src/main/java/com/example/WebStatResourceMvc.java
